...
`;
buttonShop.innerHTML = svg + " Follow on" +shopPaySvg;

footerButton.appendChild(buttonShop);
...
socialIcons.appendChild(socialIconsList);
footerButton.appendChild(socialIcons);
...
let lastSectionLogo = document.createElement("div");
lastSectionLogo.classList.add("last-sectionlogo")
// let lastSection = document.querySelector(".last-section");
// let lastSectionLogo = document.querySelector(".last-sectionlogo");

let lastSectionLogoList = document.createElement("ul");
...
logoItems.forEach(item => {
  ...
  lastSectionLogoList.appendChild(listItem);
});

const lastSectionFlex = document.createElement('div');
lastSectionFlex.classList.add('lastSection-flex');

const ulElement = document.createElement('ul');

const links = [
  { text: '© 2024, BlackStone', href: '/' },
  { text: 'Powered by Shopify', href: '#' },
...
lastSectionFlex.appendChild(ulElement);

lastSectionLogo.appendChild(lastSectionLogoList);
lastSection.appendChild(lastSectionLogo)
lastSection.appendChild(lastSectionFlex);
footer.appendChild(lastSection)
